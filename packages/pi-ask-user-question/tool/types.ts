...
/**
 * User-facing labels for the runtime sentinel rows, keyed by their
 ...
 * reserved so the runtime sentinel is the single source of truth and has no
 * runtime kind.
 *
...
export interface QuestionnaireResult {
	 ...
	 * Conditional-spread contract: the key appears only via conditional spread of a
	 * non-empty string — never assigned `undefined`, never kept for an
