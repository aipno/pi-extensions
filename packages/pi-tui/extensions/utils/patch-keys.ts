/**
 * pi-tui 补丁所有权与跨模块协调键的单一来源（single source of truth）。
 *
...
export const COMPACT_MODE_PATCH_KEY = Symbol.for("pi.tui.compact-mode-patch");
export const COMPACT_THINKING_PATCH_KEY = Symbol.for("pi.tui.compact-thinking-update");
export const PROTOTYPE_ORIGINAL_KEY = Symbol.for("pi.tui.prototype-original");
export const COMPACT_THINKING_OWNER = Symbol.for("pi.tui.compact-thinking-owner");

// ── assistant 展开状态（实例标记；description 供旧模块按 symbol.description 清理） ──
export const ASSISTANT_SET_EXPANDED_DESCRIPTION = "pi.tui.compact-assistant-set-expanded";
export const ASSISTANT_TOGGLE_ROUND_DESCRIPTION = "pi.tui.compact-assistant-toggle-round";
export const ASSISTANT_REENTRY_DESCRIPTION = "pi.tui.compact-assistant-reentry";
...
// ── 工具渲染补丁 ──
export const GLOBAL_TOOL_RENDER_PATCH = Symbol.for("pi.tui.global-tool-render-patch");
export const COMPONENT_TOOL_RENDER_MODE = Symbol.for("pi.tui.component-tool-render-mode");
export const TOOL_EXPANDED_BACKGROUND_PATCH = Symbol.for(
	"pi.tui.tool-expanded-background-patch",
);

// ── 消息组件补丁 ──
export const MESSAGE_DISPLAY_PATCH = Symbol.for("pi.tui.message-display-patch");

// ── 压缩渲染补丁（/reload 残留 deactivate 用） ──
export const GLOBAL_COMPACTION_RENDER_PATCH = Symbol.for("pi.tui.compaction-render-patch");

// ── 工具分组 ──
export const TOOL_GROUPING_PATCH_KEY = Symbol.for("pi.tui.tool-grouping-patch");
export const TOOL_GROUPING_PARENT_KEY = Symbol.for("pi.tui.tool-grouping-parent");
export const TOOL_GROUPING_GENERATION_KEY = Symbol.for("pi.tui.tool-grouping-generation");

// ── 鼠标交互 ──
export const TOOL_MOUSE_OWNER_KEY = Symbol.for("pi.tui.tool-mouse-owner");
export const TOOL_MOUSE_TUI_SLOT = Symbol.for("pi.tui.tool-mouse-tui");
export const SCROLL_BUTTON_STATE_SLOT = Symbol.for("pi.tui.scroll-button-state");
export const FLUSH_DOCKED_BASH_PATCH = Symbol.for("pi.tui.flush-docked-bash-patch");
export const TOOL_HOVER_STATE_KEY = Symbol.for("pi.tui.tool-hover-state");

// ── rich diff 组件标记 ──
export const RICH_DIFF_COMPONENT = Symbol.for("pi.tui.rich-diff-component");
