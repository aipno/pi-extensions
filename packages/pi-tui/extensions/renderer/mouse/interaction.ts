import { hasActiveTextPreview, showTextPreview } from "../../feature/text-preview.ts";
...
const TOOL_MOUSE_WIDGET_KEY = "pi-tui-tool-mouse";
const TOOL_MOUSE_MOTION_ENABLE = "\x1b[?1003h\x1b[?1006h";
const TOOL_MOUSE_MOTION_DISABLE = "\x1b[?1003l";
const FULLSCREEN_MOTION_ENABLED = Symbol("pi.tui.fullscreen-motion-enabled");
...
/** Summary markers used by Pi and pi-tui; unlike the trailing hint, these survive truncation. */
...
const FULLSCREEN_VIEWPORT_PATCH = Symbol("pi.tui.fullscreen-viewport-patch");
const FULLSCREEN_WHEEL_SCROLL_ORIGINAL = Symbol("pi.tui.fullscreen-wheel-scroll-original");
