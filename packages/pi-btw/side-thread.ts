...
/**
 * Build the message list for the next question. The first turn carries the
 * conversation context; follow-ups reuse the assistant responses as history
 * so the side discussion stays coherent without touching the main session.
 */
...
/** One-shot side question without an open thread; useful to other extensions. */
